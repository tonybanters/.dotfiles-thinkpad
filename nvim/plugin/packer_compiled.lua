...
_G.packer_plugins = {
  ...
  nvim = {
    loaded = true,
    path = "/home/tony/.local/share/nvim/site/pack/packer/start/nvim",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/tony/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/home/tony/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
    url = "https://github.com/inkarkat/vim-ReplaceWithRegister"
  },
  ["vim-maximizer"] = {
    loaded = true,
    path = "/home/tony/.local/share/nvim/site/pack/packer/start/vim-maximizer",
